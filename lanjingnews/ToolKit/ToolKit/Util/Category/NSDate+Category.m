...
///* 时间描述*/
//+ (NSString*)timeIntervalDescriptionFromTime:(NSTimeInterval)time
//{
//    NSDate *date = [NSDate dateWithTimeIntervalSince1970:time];
//    NSTimeInterval tmpTime = -[date timeIntervalSinceNow];
//    
//    NSString *strTime;
//    if (tmpTime < 5*60) {
//        strTime = @"刚刚";
//    }else if (tmpTime < 60 * 60){
//        strTime = [NSString stringWithFormat:@"%ld分钟前",(long)(tmpTime / 60)];
//    }else if (tmpTime < 60 * 60 * 24){
//        strTime = [NSString stringWithFormat:@"%ld小时前",(long)(tmpTime / (60 * 60))];
//    }else if (tmpTime < 60 * 60 * 24 * 30){
//        strTime = [NSString stringWithFormat:@"%ld天前",(long)(tmpTime / (60 * 60 * 24))];
//    }else if (tmpTime < 60 * 60 * 24 * 30 * 12){
//        strTime = [NSString stringWithFormat:@"%ld个月前",(long)(tmpTime / (60 * 60 * 24 * 30))];
//    }else if (tmpTime > 60 * 60 * 24 * 30 * 12){
//        strTime = [NSString stringWithFormat:@"一年前"];
//    }
//    return strTime;
//}
