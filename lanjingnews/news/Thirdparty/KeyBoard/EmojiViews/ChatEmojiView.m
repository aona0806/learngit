...
-(void)initUI{
    ...
    frame.origin.y = CGRectGetHeight(frame) - EmojiView_Border;
...
-(void)addBottom:(CGRect)frame{
    ...
    [common setImage:[UIImage imageNamed:@"emoji_1_"] forState:UIControlStateNormal];
...
//    self.iconS = @[common,panda];
    ...
    sendB.titleLabel.font = [UIFont systemFontOfSize:12];
