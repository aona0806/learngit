...
-(void)initUI{
    ...
    [_Album setImage:[UIImage imageNamed:@"keyboard_button_pic"] forState:UIControlStateNormal];
    [_Album setImage:[UIImage imageNamed:@"keyboard_button_pic"] forState:UIControlStateHighlighted];
//    [_Album setTitle:@"图片" forState:UIControlStateNormal];
    ...
    [_Camera setImage:[UIImage imageNamed:@"keyboard_button_photo"] forState:UIControlStateNormal];
    [_Camera setImage:[UIImage imageNamed:@"keyboard_button_photo"] forState:UIControlStateHighlighted];
