...
- (void)updatePage
{
    ...
    if (self.dataSource && [self.dataSource respondsToSelector: @selector(calendarScrollToNewPageWithdate:withBool:)])
    {
        [self.dataSource calendarScrollToNewPageWithdate: currentDate withBool:self.calendarAppearance.isWeekMode];
    }
